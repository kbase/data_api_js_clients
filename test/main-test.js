...
requirejs.config({
    ...
    paths: {
        ...
        thrift: 'bower_components/kbase-data-thrift-js/js/lib/thrift-core',
        thrift_transport_xhr: 'bower_components/kbase-data-thrift-js/js/lib/thrift-transport-xhr',
        thrift_protocol_binary: 'bower_components/kbase-data-thrift-js/js/lib/thrift-protocol-binary',
